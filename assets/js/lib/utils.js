...
if(typeof window.log === "undefined") {
	var log =  function() {
		...
		// }
		if(console) {
			if(typeof global === "undefined" || ( typeof global !== "undefined" && global.env != "prod") ) console.log(arguments);
		}
	};
}
...
if(typeof window.augment === "undefined") {
	augment = function(destination, source) {
...
//      var add;
//      if(typeof window.addEventListener !== 'undefined') {
//          add = function(elt, type, listener, useCapture) {
	...
	var addEvent = (function() {
		...
		return function() {
			if(typeof arguments[1] == "string")
				...
				for(var type in arguments[1]) {
					if(arguments[1].hasOwnProperty(type))
						add(arguments[0], type, arguments[1][type]);
				}
		}
	}) ();
}

if(typeof window.removeEvent === "undefined") {
	var removeEvent = (function() {
		var remove;
		if(typeof window.removeEventListener !== 'undefined') {
			remove = function(elt, type, listener, useCapture) {
				elt.removeEventListener(type, listener, useCapture);
			};
		}
		else {
			remove = function(elt, type, listener, useCapture) {
				elt.detachEvent('on'+type, listener);
			};
		}
		return function() {
			if(typeof arguments[1] == "string")
				...
				for(var type in arguments[1]) {
					if(arguments[1].hasOwnProperty(type))
						remove(arguments[0], type, arguments[1][type]);
				}
		}
	}) ();
}
...
if(typeof window.isDescendant === "undefined") {
